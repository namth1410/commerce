...
export default function FloatingSocialIcons() {
  ...
  // Sử dụng useFloating mà không cần ref `reference` và `floating`
  const { x, y, strategy, refs, update } = useFloating({
    placement: "top-end", // Xác định vị trí phần tử nổi
  ...
  return (
    <div className="fixed bottom-4 right-4">
      {/* Floating Button */}
      <button
        ref={refs.setReference} // Sử dụng refs.setReference thay vì trực tiếp sử dụng ref
        onClick={() => setIsOpen(!isOpen)}
        style={{
          background:
            "url('https://shopdunk.com/images/uploaded-source/icon/hotline.png') left center no-repeat",
          backgroundSize: "56px 56px", // Không dùng !important trong inline styles
          height: "56px",
          width: "56px",
          cursor: "pointer",
          position: "fixed",
      ...
      {/* Social Icons (Floating UI) */}
      <div
        ref={refs.setFloating} // Sử dụng refs.setFloating thay vì trực tiếp sử dụng ref
        style={{
          position: strategy,
          top: y,
          left: x,
          display: isOpen ? "flex" : "none",
          width: "160px", // Animation width
          height: "160px", // Animation height
          transition: "width 1s ease",
        }}
        className="bg-white p-2 rounded-lg shadow-md flex flex-col gap-4"
      >
        {/* Zalo Icon */}
        <a
          href="https://zalo.me/"
        ...
        >
          <img
            src="https://shopdunk.com/images/uploaded-source/icon/ic_messenger.png"
            alt="Facebook"
            className="w-8 h-8"
          />
        </a>
      ...
      <div
        ...
        className={`transition-all duration-500 ${
          isOpen ? "w-[160px] h-[160px]" : "w-0 h-0"
        } fixed bottom-[80px] right-[80px]`}
        style={{
          position: "fixed",
      ...
      >
        <div
          className={`transition-opacity duration-500 ease-in-out transform origin-bottom-right ${
            isOpen
        ...
        >
          ...
          <a
            ...
            className={`absolute transition-transform duration-500 ${
              isOpen
                ? "transform translate-x-[110px] translate-y-[-20px]"
                : "transform translate-x-[0px] translate-y-[0px]"
            }`}
            style={{
              background: "#FFFFFF",
              border: "1px solid #EBEBEB",
          ...
          <a
            ...
            className={`absolute transition-transform duration-500 ${
              isOpen
                ? "transform translate-x-[20px] translate-y-[80px]"
                : "transform translate-x-[0px] translate-y-[0px]"
            }`}
            style={{
              background: "#FFFFFF",
